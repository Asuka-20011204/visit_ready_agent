...
3. 每个事实、症状画像、时间线和风险提示必须逐字引用用户原文中的最短充分片段作为 source_quote；症状画像中来自后续回答的字段值可逐字引用到 evidence_quotes，每条也必须是用户回答中的原文，不得做无证据的规范化改写或补全。
